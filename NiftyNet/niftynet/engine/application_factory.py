...
SUPPORTED_LOSS_SEGMENTATION = {
    ...
    "Dice_brats" :
        'niftynet.layer.loss_segmentation.dice_brats',
    "Dice_brats_mrbrains" :
        'niftynet.layer.loss_segmentation.dice_brats_mrbrains',
    "Dice_brats2" :
        'niftynet.layer.loss_segmentation.dice_brats2',
    "Dice_brats_uni" :
        'niftynet.layer.loss_segmentation.dice_brats_uni',
    "Dice_brats_uni_prob" :
        'niftynet.layer.loss_segmentation.dice_brats_uni_prob',
    "Dice_brats_V2":
        'niftynet.layer.loss_segmentation.dice_brats_V2',
    "Dice_transfert":
        'niftynet.layer.loss_segmentation.dice_transfert',  
    "Jaccard":
        'niftynet.layer.loss_segmentation.jaccard', 
    "Jaccard_prob":
        'niftynet.layer.loss_segmentation.jaccard_prob', 
    "Jaccard_lesion":
        'niftynet.layer.loss_segmentation.jaccard_lesion', 
    "Dice_constraint":
        'niftynet.layer.loss_segmentation.dice_constraint', 
    
    "Dice":
        'niftynet.layer.loss_segmentation.dice',
    "Dice_binary_alone":
        'niftynet.layer.loss_segmentation.dice_binary_alone',   
    "Dice_NS":
