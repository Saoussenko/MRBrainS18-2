...
def __add_segmentation_args(parser):
    ...
    SUPPORTED_INPUT = SUPPORTED_INPUT | set(['image_brats', 'image_sym', 'image_parcellation', 'sampler_brats', 'label_brats', 'label_sym', 'label_parcellation', 'weight', 'sampler', 'inferred', 'window_sampling_brats','window_sampling_sym' ,'window_sampling_parcellation'])
    parser = add_input_name_args(parser, SUPPORTED_INPUT)
    return parser
