...
class SegmentationApplication(BaseApplication):
    ...
    def initialise_dataset_loader(
        ...
        if self.is_training:
            ...
            file_list = pd.concat([data_partitioner.inference_files,data_partitioner.validation_files],axis=0)
    ...
    def connect_data_and_network(self,
        ...
        if self.is_training:
            ...
            net_out = self.net({MODALITIES[k]: tf.expand_dims(image[k],-1) for k in range(2)}, is_training=True)
